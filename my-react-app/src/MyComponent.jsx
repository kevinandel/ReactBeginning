import React, {useState, useEffect, useRef} from 'react'; //useRef() is similar to useState() but does not cause rerenders, but remembers some information 

function MyComponent() {

  const inputRef1 = useRef(null); //interacting with those buttons does not cause the page to rerenders thats the speciality of useRef() hook
